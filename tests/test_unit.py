...
FILE_NAME = "bukti chatbot repi 3.png"
FILE_SIZE = 77604
FILE_URI = "https://ipfs.infura.io/ipfs/QmZ2AxgaLEVN7wKfNREb9Aw8MjxukA1gfUiSJgDTjCXUsi"
...
def test_upload_and_get_file():
    ...
    print ("test upload and get file success!")
